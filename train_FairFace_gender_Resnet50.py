...
def train(nb_epoch, batch_size, store_name, resume=False, start_epoch=0, model_path=None, data_path = '/home/UNT/am3358/FineFACE'):
    ...
    trainset = torchvision.datasets.ImageFolder(root=data_path+'/fairface_train_gender', transform=transform_train)
    ...
    net = Network_Wrapper(net_layers, 2)
...
if __name__ == '__main__':
    ...
    data_path = '/home/UNT/am3358/FineFACE'
    os.environ["CUDA_VISIBLE_DEVICES"] = "0"
    train(nb_epoch=25,             # number of epoch
             batch_size=16,         # batch size
             store_name='Results_FairFace_Gender_ResNet50',     # folder for output
